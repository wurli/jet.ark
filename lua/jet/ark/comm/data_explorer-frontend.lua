...
M.schema_update = function(kernel, comm_id)
	return util.rpc_request(kernel, comm_id, "schema_update", nil)
end
...
---@param kernel jet.Kernel
---@param comm_id string
M.data_update = function(kernel, comm_id)
	return util.rpc_request(kernel, comm_id, "data_update", nil)
end
